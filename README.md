...
<!-- Unordered list item with a description of the developer's passion and experience -->

- 🚚 CDN : https://cdn.jsdelivr.net/gh/zeeid/nama_repository/lokasi_file [*Without Branch name maybe] || repo@branch/location/
<!-- Unordered list item with a CDN link -->
...
<!-- Paragraph element centered with a link to a GitHub profile trophy image -->
